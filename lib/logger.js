...
export function updateStatusLine(clientCount, providerName = "N/A") {
    ...
    const status = `\x1b[s\x1b[1;1H${bgColor}${textColor} vAMET LHBP | ${getLocalIpAddress()}:${config.server.port} | ${green}${clientCount}${textColor} clients | ${green}${providerName}${bgColor} \x1b[K${reset}\x1b[u`;
